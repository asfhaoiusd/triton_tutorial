...
**从 [`kernel/triton/tutorial/README.md`](kernel/triton/tutorial/README.md) 按编号走。** 中文讲义：[`docs/textbook/`](docs/textbook/)，`cd docs/textbook && make`。作者学习日记：[`学习计划书.md`](kernel/triton/tutorial/学习计划书.md)。
...
docs/textbook/                   讲义源码（PDF 本地 make，不进仓库）
```
